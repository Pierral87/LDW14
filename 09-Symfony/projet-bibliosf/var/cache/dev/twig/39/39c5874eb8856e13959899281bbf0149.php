...
\t\t\t";
    ...
    public function block_titreH1($context, array $blocks = [])
    {
        $macros = $this->macros;
        $__internal_5a27a8ba21ca79b61932376b2fa922d2 = $this->extensions["Symfony\\Bundle\\WebProfilerBundle\\Twig\\WebProfilerExtension"];
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "titreH1"));
...
\t\t{% block body %}
\t\t\t
\t\t\t{# Ici c'est un commentaire en twig #}
\t\t\t{# Grâce au twig, lorsque je veux simplement afficher une variable transmise par le controller, j'insère ça dans des doubles accolades, pas besoin de spéicifier le \$ des variables php, on est dans un autre langage, j'écris directement le nom de la variable #}
\t\t\t{# 
\t\t\t            
\t\t\t                {{}} : balise twig qui correspond à <?= ?>
...
", "base.html.twig", "D:\\wamp64\\www\\LDW14\\09-Symfony\\projet-bibliosf\\templates\\base.html.twig");
    }
}
